...
CONFIG = {
    ...
    "prompts": {
        ...
        3. 상충되는 신호들의 우선순위 판단
        4. 리스크 대비 수익률 최적화
        5. 현재 포지션 상태에 따른 맞춤 전략

        중요 고려사항:
        - 15분봉 기준 단기 매매이므로 기술적 분석과 시장 심리가 중요
        - 거시경제와 온체인 분석은 중장기 방향성 확인용
        ...
        {{
            ...
            "recommended_action": {{
                ...
                "mandatory_stop_loss": "필수 스톱로스 가격",
                "mandatory_take_profit": "필수 테이크프로핏 가격"
            }},
            "reverse_analysis": {{
